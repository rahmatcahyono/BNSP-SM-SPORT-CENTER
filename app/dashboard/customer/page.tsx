...
import { CalendarDays, CheckCircle, Clock, ListChecks, Plus, QrCode, Bell, MapPin, ArrowRight } from "lucide-react";
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5 md:p-6">
            <div className="flex items-center justify-between mb-5">
              <div>
                <h2 className="text-base font-bold text-gray-800">Riwayat Pemesanan</h2>
                <p className="text-xs text-gray-400 mt-0.5">Pantau status pembayaran dan tiket Anda</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-amber-50 rounded-xl border border-amber-100">
                <p className="text-xs font-bold text-amber-800 mb-1">Maintenance Rutin</p>
                <p className="text-[11px] text-amber-700 leading-relaxed">
                  Lapangan Badminton 3 akan ditutup untuk perbaikan lantai vinyl pada tanggal 25-26 Juli. Mohon maaf atas ketidaknyamanannya.
                </p>
              </div>
              <div className="p-3 bg-blue-50 rounded-xl border border-blue-100">
                <p className="text-xs font-bold text-blue-800 mb-1">Promo Member Baru 🎁</p>
                <p className="text-[11px] text-blue-700 leading-relaxed">
                  Dapatkan diskon 10% untuk pemesanan pertama Anda khusus di lapangan Futsal Indoor.
                </p>
              </div>
            </div>
          </div>
